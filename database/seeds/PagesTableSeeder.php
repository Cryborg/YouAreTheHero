...
rendre où elle le désire (ignorez alors le lancer de dé et choisissez la direction à prendre).</p>',
            ...
            array (
                ...
                'is_last' => 0,
                'title' => '8',
                'content' => '<p>Battant des ailes de plus en plus rapidement tout en poursuivant sa course, la fourmi prend finalement
...
fourmi coincée sous une de ses ailes.</p>
<p>Il va falloir que votre insecte tienne 3 tours avant que ses congénères ne viennent à son secours et
poussent le volatile à reprendre de l\'altitude.</p>
<p>Dé :</p>
<p>1 : le volatile transperce votre fourmi de son bec. Elle meurt sur le coup. L\'oiseau se rendra bientôt
compte que le goût des sexués est aussi acide que celui des autres.</p>
<p>2 : l\'adversaire empoigne la fourmi dans ses serres et les referme violemment sur elle (elle perd 3 états
de Vitalité et Carapace).</p>
<p>3 : un violent coup de serre fait perdre 2 états de Vitalité et Carapaçonnage à votre fourmi.</p>
<p>4 : du fait d\'un coup latéral du bec, votre fourmi perd un état de Vitalité et Carapaçonnage.</p>
<p>5 : Votre fourmi esquive avec adresse les attaques du volatile.</p>
<p>6 : un violent coup de mandibule infligé à l\'une des pattes de l\'animal le fait reculer. Voyant que des
renforts arrivent, il préfère abandonner immédiatement le combat.</p>
<p>Si votre insecte survit, votre fourmi peut récupérer une plume qu\'a perdu le volatile dans ce combat
épique. Inscrivez plume sur le Feuille d\'aventure. Le groupe atteint ensuite le couvert des arbres avant
une nouvelle attaque, puis finit par rejoindre le chemin, qui se termine bientôt.</p>',
                'layout' => 'play1',
                'is_checkpoint' => 0,
            ...
            array (
                ...
                'is_last' => 0,
                'title' => '86',
                'content' => '<p>La progression du groupe est pendant un temps masquée par les plantes qui jalonnent son parcours et
...
d\'éventuels prédateurs aériens…</p>
<p>Tandis que le groupe accélère instinctivement le pas, une ombre passe sur certaines fourmis. Puis une
...
que la fourmi qui tirera sur le volatile dépensera 4 gouttes d\'acide).</p>
<p>Si c\'est une sexuée et qu\'elle veut profiter de ses ailes pour fuir plus aisément le volatile, allez au 8.</p>
<p>Sinon, elle peut profiter du vol bas de l\'animal pour sauter sur ses serres puis fourrager dans ses plumes,
...
rendez-vous au 34.</p>',
            ...
            array (
                ...
                'is_last' => 0,
                'title' => '60',
                'content' => '<p>Sunt dolores repellat error possimus qui sit. Quasi eos ad blanditiis occaecati. Explicabo a accusamus vero nulla unde quidem temporibus aperiam.</p>',
                'layout' => 'play1',
                'is_checkpoint' => 0,
...
équipes s\'organisent, pour explorer chacun de ces lieux. Les exploratrices en ont trouvé six.</p>',
            ...
            array (
                ...
                'is_last' => 0,
                'title' => '94',
                'content' => '<p>Le groupe d\'exploration auquel s\'est jointe votre fourmi est constitué, mis à part elle, uniquement
...
passer par les interstices qui se trouvent entre lui et l\'encadrement pierreux.</p>
<p>Vous pouvez décider que votre fourmi se fraie un passage dans le bois (si c\'est une guerrière, son
physique la prédispose à cette tâche et cela devient une obligation à moins d\'être accompagné par une
Grosse fourmi) : rendez-vous au 113.</p>
<p>Sinon, votre insecte peut patienter le temps que quelques ouvrières (ou la Grosse fourmi, si elle
l\'accompagne) ouvrent le passage : allez au 9.</p>',
                'layout' => 'play1',
                'is_checkpoint' => 0,
            ...
            array (
                ...
                'is_last' => 0,
                'title' => '25',
                'content' => '<p>Alors que la petite troupe d\'incursion continue de suivre la piste tracée voilà presque une demi-saison
...
danger trop important pour le groupe ? Des vibrations dans le sol commencent déjà à se faire sentir…</p>
<p>Si votre fourmi est accompagnée d\'une artilleuse, ou si elle est elle-même capable de lancer des jets
d\'acide et que vous souhaitez utiliser cette capacité (dans ce cas, sachez qu\'elle dépensera 4 gouttes
d\'acide), allez au 43.</p>
<p>Sinon, allez au 74.</p>',
                'layout' => 'play1',
                'is_checkpoint' => 0,
            ...
            array (
                ...
                'is_last' => 0,
                'title' => '38',
                'content' => '<p>Sapiente magnam nostrum et vel magni amet aut. Culpa natus est eum officiis sit aut. Culpa laudantium ea minus aut eveniet animi maiores. Tenetur nihil nisi veniam molestiae quidem.</p>',
                'layout' => 'play1',
                'is_checkpoint' => 0,
            ...
            array (
                ...
                'is_last' => 0,
                'title' => '101',
                'content' => '<p>La fourmi descend au plus profond de la fourmilière. La température y est plus chaude, et les artères du
...
raisons oisives telles que le besoin hypothétique d\'une présence maternelle.</p>
<p>Franchissant des rangs de nourrices occupées à transporter les œufs, s\'immisçant au milieu du groupe
...
composition.</p>
<p>Si vous désirez que votre fourmi acquière une phéromone de guerre, qui stimulera toutes les
combattantes alliées dans un périmètre proche de votre fourmi, rendez-vous au 23.</p>
<p>Si vous préférez une phéromone de séduction, afin de pouvoir persuader ses compagnons de la conduite à
tenir, ou d\'attirer irrésistiblement les mâles reproducteurs qu\'elle pourra croiser durant son équipée
(éventualité peu probable), allez au 38.</p>
<p>Notez que pour obtenir une de ces phéromones, il vous faudra dépenser une unité de temps
supplémentaire. N\'oubliez pas que vous avez déjà dû retrancher 1 unité de temps pour parvenir jusqu’à la
reine.</p>
<p>S\'il ne reste pas assez de temps, ou si l\'acquisition de phéromones ne vous intéresse pas, rendez-vous au
12.</p>',
                'layout' => 'play1',
                'is_checkpoint' => 0,
            ...
            array (
                ...
                'is_last' => 0,
                'title' => '2',
                'content' => '<p>Ex quibusdam aut facilis facilis. Ullam est possimus consectetur repudiandae ab. Et eum debitis nostrum et repellendus quidem magni. Ipsum facilis velit eos ducimus.</p>',
                'layout' => 'play1',
                'is_checkpoint' => 0,
            ...
            array (
                ...
                'is_last' => 0,
                'title' => '11',
            'content' => '<p>Les guerrières ont un peu faim (cet état de fait est d\'ailleurs généralisé à quasiment toute la fourmilière)
: leur instinct les aurait de toutes manières bientôt poussé à sortir chasser. Votre fourmi ne fait que
donner le déclic qui leur manquait.</p>
<p>Notez les deux Guerrières à mandibules arquées dans la liste de compagnons spéciaux. Tant qu\'elles
resteront en vie, elles seront d\'un soutien non négligeable, en particulier pour les combats au corps à
corps.</p>
<p>N\'oubliez pas de retrancher 3 unités de temps au total encore disponible.</p>
<p>Il est temps de faire un autre choix d\'action : rendez-vous au 12.</p>',
                'layout' => 'play1',
                'is_checkpoint' => 0,
            ...
            array (
                ...
                'is_last' => 0,
                'title' => '88',
                'content' => '<p>Le sentiment d\'urgence qui a été transmis à la fourmi lors de sa rencontre avec la soldate devient
...
Il est temps de faire un autre choix d\'action.</p>',
            ...
            array (
                ...
                'is_last' => 0,
                'title' => '29',
                'content' => '<p>Le fait que l\'édifice soit habité, même par des insectes de taille réduite, entraîne automatiquement que
le groupe auquel se joint votre fourmi contient une soldate. Le reste est naturellement composé
d\'ouvrières.</p>
<p>L\'équipe se met en route, et parvient sans encombre jusqu\'au bâtiment. Son ouverture béante,
devancée par des plaques de métal et un matériau transparent, permet au groupe de rester en bloc, et
les fourmis pénètrent dans ce lieu silencieux.</p>
<p>D\'épaisses colonnes montent dans les hauteurs, et de grandes pierres semblent avoir été taillées pour
former des êtres inconnus, visiblement assez savants pour découper la roche, et avec précision.</p>
<p>L\'ouvrière qui avait repéré l\'édifice indique par quelques phéromones inquiètes une direction : selon elle,
...
immédiatement battu en retraite), sans pouvoir en dire plus sur leur nature.</p>
<p>Lancez un dé pour savoir dans quelle direction le groupe va se diriger. Si vous obtenez 1 ou 2, les fourmis
se rendent dans l\'endroit signalé comme étrange. Allez au 22. Sinon, elles vont tenter de trouver la
source de nourriture des insectes, quittes à engager le combat. Rendez-vous au 19.</p>
<p>Si votre fourmi possède une phéromone de séduction, elle peut influencer le choix du groupe : décidez
alors du paragraphe où vous souhaitez vous rendre.</p>',
                'layout' => 'play1',
                'is_checkpoint' => 0,
...
rendez-vous au 119. </p><p>Sinon, laissez-la saisir sa chance en vous rendant au 58.</p>',
            ...
            array (
                ...
                'is_last' => 0,
                'title' => '99',
                'content' => '<p>Une feuille est assez grande pour accueillir de deux à trois fourmis maximum. Assouvissant leur besoin
...
d\'arriver à destination. Finalement, la plupart des feuilles n\'accueillent qu\'une seule fourmi.</p>
<p>Si la vôtre possède une plume, elle peut l\'utiliser à la place d\'une feuille, pour profiter de son étanchéité :
allez alors au 77. Sinon, elle se contentera d\'une feuille, comme les autres, et vous vous rendrez au 95</p>',
                'layout' => 'play1',
                'is_checkpoint' => 0,
...
hors de portée de la bête. Allez alors au 42.
            ...
            array (
                ...
                'content' => '<p>Illo dolorem laboriosam qui dolor. Facilis temporibus iste vel facilis saepe. Blanditiis aut nobis nihil ut reprehenderit ex.</p>',
                'layout' => NULL,
                'is_checkpoint' => 1,
...
quelques phéromones apaisantes.</p>
<p>La soldate va continuer à recruter quelques membres supplémentaires pour l\'expédition à venir, ce qui
...
des cris de mammifères.</p>
<p>Du couloir principal, le groupe se divise en deux pour couvrir les deux directions. Votre fourmi suit le
...
N\'oubliez pas de retrancher 2 unités de temps au total encore disponible.
            ...
            array (
                ...
                'is_last' => 0,
                'title' => '47',
                'content' => '<p>Si votre protégée a recruté un ou des compagnons, ceux-ci l\'accompagnent.
...
léger courant d\'air, il pourrait être intéressant de voir ce qui se cache derrière.</p>
<p>Si la fourmi décide de prendre le passage grimpant de manière régulière, rendez-vous au 59. Si elle
...
une telle hauteur ne la fasse pas trop virevolter (rendez-vous alors au 31).</p>',
                'layout' => 'play1',
                'is_checkpoint' => 0,
            ...
            array (
                ...
                'is_last' => 0,
                'title' => '23',
                'content' => '<p>Eius quidem debitis aut sapiente. Et autem libero id corporis aut deserunt accusantium. Sed error ipsum doloribus sed iure ut numquam.</p>',
                'layout' => 'play1',
                'is_checkpoint' => 0,
            ...
            array (
                ...
                'is_last' => 0,
                'title' => '52',
                'content' => '<p>La fourmi transporte une à une ses congénères à l\'autre rive. Les multiples allers et retour la fatigue mais
l\'esprit de groupe et l\'importance de sa mission la soutiennent.</p>
<p>Finalement, chaque exploratrice arrive à bon port.</p>
<p>N\'oubliez pas de diminuer la Faim de votre fourmi d\'un niveau.</p>
<p>Rendez-vous au 40.</p>',
                'layout' => 'play1',
                'is_checkpoint' => 0,
            ...
            array (
                ...
                'is_last' => 0,
                'title' => '92',
                'content' => '<p>Chaque fourmi se presse contre ses compagnes, cherchant à utiliser au maximum la place offerte par le
...
compagnes (elle regagne un niveau de Faim).</p>
<p>Tandis que le groupe se fait compact plus que jamais, les projectiles mortels commencent à tomber du
...
derniers sont décédés).</p>
<p>Les griffes plantées dans le sol ou le bois, les survivantes s\'endorment peu à peu avec le froid qui
s\'immisce dans la nuit noire. Leur sommeil sera néanmoins troublé par les vibrations qu\'engendrent les
chutes de projectiles liquides.</p>
<p>Au petit matin, alors que la terre a absorbé la majeure partie de l\'acidité, le groupe encore affaibli par le
froid décide de se remettre en route sans tarder. Les odeurs d\'acides oléiques émises par les cadavres de
leurs anciennes compagnes ne sont en effet guère réjouissantes.</p>',
                'layout' => 'play1',
                'is_checkpoint' => 0,
...
votre fourmi ailée et son compagnon ont mieux à faire… Rendez-vous au 69.</p>',
            ...
            array (
                ...
                'content' => '<p>Omnis molestiae reiciendis quis officiis nisi qui accusamus. Quo et magnam et nobis doloremque asperiores veniam. Et modi odit nihil ut.</p>',
                'layout' => NULL,
                'is_checkpoint' => 1,
...
plus au ras du sol, donne quelques coups de becs. Certaines fourmis parviennent à les éviter, d\'autres
sont transpercées. On essaie de contre-attaquer, mais les mandibules claquent systématiquement dans
le vide. Le temps que le groupe atteigne le bout de la clairière, il ne restera guère de survivantes…</p>',
                'layout' => 'play1',
                'is_checkpoint' => 0,
...
N\'oubliez pas de retrancher 2 unités de temps au total encore disponible.</p>',
            ...
            array (
                ...
                'is_last' => 0,
                'title' => '63',
                'content' => '<p>Votre fourmi lance quelques phéromones d\'excitation et d\'encouragement à la suivre, puis elle reprend
...
concentré, finira par transpercer le trop fin rempart végétal.</p>
<p>Le groupe maintient sa vive allure malgré le froid et les premières gouttes corrosives qui s\'écrasent
...
état de Vitalité et Carapace. Seule la chance permettra au groupe de survivre à ce cataclysme.</p>
<p>Lancez un dé. Si le résultat est pair, rendez-vous au 79. Dans le cas contraire, allez au 85.</p>',
                'layout' => 'play1',
                'is_checkpoint' => 0,
            ...
            array (
                ...
                'is_last' => 0,
                'title' => '26',
                'content' => '<p>Assise sur son abdomen, la fourmi ajuste sa visée puis envoie quelques gouttes au volatile qui se
...
continues de l\'air laissent à penser que l\'oiseau émet des ondes sonores de douleur.</p>
<p>Le groupe se presse de regagner la protection des branches aux feuilles biscornues. Quelques pertes sont
à dénombrer, mais cela aurait pu être bien pire. Un moment plus tard, le groupe rejoint la piste, qui se
termine bientôt sur un obstacle redoutable.</p>',
                'layout' => 'play1',
                'is_checkpoint' => 0,
            ...
            array (
                ...
                'is_last' => 0,
                'title' => '115',
                'content' => '<p>Le groupe continue sa marche, qu\'il essaie de rendre la plus rapide possible malgré la diminution
...
limite externe. C\'est pourquoi on hésite à poursuivre encore la marche.</p>
<p>Si vous désirez que votre insecte donne le déclic qui manque pour la poursuite de la marche, rendez-vous
au 63.</p>
<p>Si vous pensez que ce lieu conviendra, dirigez-vous au 92.</p>',
                'layout' => 'play1',
                'is_checkpoint' => 0,
            ...
            array (
                ...
                'is_last' => 0,
                'title' => '110',
                'content' => '<p>Votre fourmi prévient par contact antennaire quelques membres du groupe compact, qui font
immédiatement passer l\'information à leurs voisins. Bientôt, tout le monde suit la piste parfumée que
votre insecte a tracée en direction du terrier.</p>
<p>Les guerrières s\'engouffrent les premières dans le trou et n\'y découvrent aucune présence autre que
...
endormie par le froid.</p>
<p>D\'un commun accord, les fourmis décident donc de faire de ce trou leur antre. Elles ancrent leurs griffes
...
manque de chaleur finit cependant par inhiber toute sensation.</p>
<p>Au petit matin, le groupe s\'éveille lentement. Les premières fourmis réveillées lèchent leurs compagnes
...
suffisante.</p>
<p>Quand tout le monde est éveillé, quand les pattes sont dégourdies et qu\'on estime qu’il est temps de
...
Nord, quitte à emprunter un chemin peu sûr car non balisé.</p>
<p>Si votre fourmi est capable de sécréter des phéromones de séduction et que vous pensez sage de
continuer à suivre la piste parfumée, rendez-vous au 60.</p>
<p>Sinon, avec son consensus habituel, le groupe décide de tenter un raccourci. Allez au 86.</p>',
                'layout' => 'play1',
                'is_checkpoint' => 0,
            ...
            array (
                ...
                'is_last' => 0,
                'title' => '34',
                'content' => '<p>Votre fourmi profite d\'un passage à ras le sol du volatile pour faire un pas de côté et sauter dans sa
...
lâchent peu à peu prise, face à ces plumes ondoyantes et ce duvet hérissé de peur et de douleur.</p>
<p>Finalement, après une descente en piquée qui a amené la fourmi au niveau du cou de l\'oiseau, une
remontée brutale l’envoie assez bas, entre les deux ailes du volatile. Aussitôt, un bec fond sur elle, tandis
que les larges membres emplumés battent derechef dans le but de la faire tomber.</p>
<p>Il va falloir affaiblir et fatiguer suffisamment le volatile pour qu\'il se pose. Votre fourmi doit tenir 6 tours
ou enlever 6 états de Vitalité à l\'oiseau.</p>
<p>Dé :</p>
<p>1 : Les ailes font valser la fourmi, qui lâche prise et s\'en va dans les airs. La chute aurait pu la blesser
grièvement… fort heureusement, elle est récupérée au vol par les serres de l\'oiseau qui l\'achève d\'un
coup de bec.</p>
<p>2 : Cherchant avant tout à raffermir ses prises, l\'insecte ne peut guère esquiver le coup de bec,
heureusement maladroit, qui vient le piquer au thorax (elle perd trois états de Vitalité et Carapace).</p>
<p>3 : La fourmi ne lâche pas prise, la mandibule enfoncée dans la chair de l\'animal, mais un coup latéral de
bec vient heurter sa carapace (elle perd deux états de Vitalité et Carapace).</p>
<p>4 : Le volatile échoue dans ses tentatives de désarçonner ou de picorer votre fourmi.</p>
<p>5 : De ses mandibules, votre fourmi laboure la chair de l\'animal (il perd deux états de Vitalité).</p>
<p>6 : Votre protégée parvient à découper un bout de chair de l\'animal ((il perd trois états de Vitalité).</p>
<p>Si votre fourmi remporte le combat, le volatile s\'écrase au sol et le reste du groupe a tôt fait de fondre
...
le Feuille d\'aventure.</p>
<p>Après ce copieux festin, les fourmis reprennent leur route et rejoignent finalement la piste parfumée.</p>
<p>Celle-ci se termine devant un nouveau défi.</p>',
                'layout' => 'play1',
                'is_checkpoint' => 0,
            ...
            array (
                ...
                'is_last' => 0,
                'title' => '64',
                'content' => '<p>Mandibules et mâchoires creusent lentement un tunnel humide. Les pattes patinent sur la terre meuble,
...
Néanmoins, les exploratrices parviennent à rejoindre l\'autre rive, sans perte.</p>',
                'layout' => 'play1',
                'is_checkpoint' => 0,
            ...
            array (
                ...
                'is_last' => 0,
                'title' => '100',
                'content' => '<p>Outre la soldate qui l\'a recrutée, la fourmi tombe antennes à antennes avec une autre guerrière aux
...
prédateurs. Il faut avancer dès maintenant et trouver un abri de fortune.</p>
<p>On se remet donc en route. Consensus immédiat, le groupe se resserre derrière les soldates, bien
...
piste odorante déjà établie par d\'autres exploratrices.</p>
<p>Les fourmis se déplacent aussi vite que faire se peut, se bousculant parfois. Les griffes s\'enfoncent et
...
tomber, et une seule goutte bien placée peut s\'avérer fatale pour une fourmi.</p>
<p>Votre insecte ainsi que quelques-uns de ses congénères s\'écartent du groupe principal pour commencer
...
<p>Si vous pensez qu\'il faut dès à présent se rendre dans ce refuge suffisamment vaste pour toutes, quitte à
retarder un peu l\'expédition, rendez-vous au 110.</p>
<p>Si vous préférez que votre fourmi ne prévienne pas ses congénères et que le groupe continue encore un
moment son avancée, allez au 115.</p>',
                'layout' => 'play1',
                'is_checkpoint' => 0,
            ...
            array (
                ...
                'is_last' => 0,
                'title' => '65',
                'content' => '<p>L\'exploratrice qui a découvert l\'endroit n\'ayant pas détecté la présence de quelconques êtres vivants,
...
ne pas s\'en encombrer.</p>
<p>Si votre fourmi (ou une de ses compagnes) possèdent deux gouttes d\'acide en réserve, rendez-vous au
30.</p>
<p>Si votre insecte possède des mandibules aiguisées et qu\'elle souhaite les utiliser sur le métal, allez au 87.</p>
<p>Sinon, il ne reste plus au groupe qu\'à explorer le reste des environs : rendez-vous au 46.</p>',
                'layout' => 'play1',
                'is_checkpoint' => 0,
            ...
            array (
                ...
                'is_last' => 0,
                'title' => '71',
                'content' => '<p>A la température basse caractéristique de ce qui a été nommé « Le plus dur des Hivers » vient s\'ajouter à
...
Pourtant, il va bien falloir contourner l\'obstacle.</p>
<p>Instinctivement, le groupe commence à planter ses mandibules dans la terre, cherchant où elle est le
plus friable, afin de creuser un profond tunnel au-dessous du cours d\'eau. Mais procéder ainsi prendra
énormément de temps et d\'énergie…</p>
<p>Une possible opportunité serait d\'utiliser un sexué pour s\'en servir comme transport aérien : la fourmi
...
berge opposée sans effort.</p>
<p>Quel que soit votre choix, sachez que le chemin parcouru dernièrement a baissé le niveau de Faim de
votre fourmi d’un niveau.</p>',
                'layout' => 'play1',
                'is_checkpoint' => 0,
