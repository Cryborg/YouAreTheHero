    ...
    public function store(Request $request)
    {
        ...
        return redirect()
            ...
            ->with('message', [
                ...
                'text' => $thread ? trans('messages.thread.sent') : trans('messages.thread.whoops'),
            ]);
    }
    ...
    public function reply(Request $request, $thread)
    {
        ...
        return redirect()
            ...
            ->with('message', [
                ...
                'text' => $message ? trans('messages.message.sent') : trans('messages.message.whoops'),
            ]);
    }
    ...
    public function destroy($thread)
    {
        ...
        return redirect()
            ...
            ->with('message', [
                ...
                'text' => $deleted ? trans('messages.thread.deleted') : trans('messages.thread.whoops'),
            ]);
    }
}
