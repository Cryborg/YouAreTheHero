...
Click on an already existing page to link to it.',
  ...
  'siblings_label_help' => 'These pages have at least one parent in common with the current page. <span class="badge badge-light border border-dark"">This part</span> is the text of the link, and the rest is the title of the child page.',
