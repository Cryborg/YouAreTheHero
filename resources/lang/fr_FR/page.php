...
return [
    ...
    'current_page_choices_help'         => "Les onglets ci-dessous correspondent aux choix qui seront proposés dans la page en cours d'édition, juste au-dessus.<br>" .
                                           "Le texte dans l'onglet sera le lien sur lequel cliquera le joueur pour atteindre la page que tu vas créer dans l'onglet.<br>" .
    ...
    'level'                             => 'Niveau',
    'level_help'                        => 'Niveau minimum que doit avoir le joueur dans la caractéristique choisie juste au-dessus pour accéder à cette page.<br>' .
                                           "Si son personnage ne l'atteint pas, le lien vers la page ne s'affichera pas.",
