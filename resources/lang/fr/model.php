...
return [
    ...
    'description_help'  => "Une fois appâtés par ton titre, la description doit conforter le lecteur dans sa volonté de lire ton histoire. N'en dis pas trop, mais suffisamment pour leur donner envie de cliquer sur le lien et commencer l'aventure :)",
    'locale'            => 'Langue',
    'layout'            => 'Layout',
    'is_published'      => 'Publié',
    ...
    'page_title_help'   => "Il s'agit ici du titre de la page. C'est totalement optionnel, sauf si tu sélectionnes l'option 'checkpoint' car ce sera alors le seul moyen d'identifier la page et d'y revenir.",
    'page_description_help' => "C'est le texte de la page, là où l'action se passe, les passions se déchirent,.... bref, là où l'histoire se déroule :)",
